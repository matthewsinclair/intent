...
- **Flags:**
  ...
  - `--apply` (bool) -- Apply this clone's plan, which bare `intent sync` prints: after a git pull, take the committed extract into the store only where it says something the store did not write
