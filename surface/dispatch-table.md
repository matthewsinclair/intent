...
- **v2:** new-surface
- **Flags:**
  - `--lines` `<n>` (string) -- How many of the most recent lines to print, from both logs merged in time order (default 40)
    - **disposition:** keep
...
- **Flags:**
  - `--depth` (string) -- How many directory levels below fromdir to search (default 4)
    - **disposition:** keep
- **MCP:** not exposed -- **mutates**
