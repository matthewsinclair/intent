...
| `organize` | --               | --apply                                                | Reconcile the tree with .intentfiles: realise what is declared, remove what is not (previews unless --apply) | ST0057 WP-04 | D57-3 (hv, 2026-08-18): the reconciliation verb of the sparse-projection model -- hydrate, verify, dehydrate, and refuse. Implemented at `intentsvcs::organize`.                                                                                                                                                                                                                                                                                                                                                               |
