...
- **ratified in:** hv, 2026-08-15, ruling applied at commit 2aec5f62
...
- **face:** surviving
- **never built:** false
- **ratified in:** hv, 2026-08-15, ruling applied at commit c1cca8c4
- **MCP:** not exposed -- **mutates**
- **Wants review:**
  - uncertain on `exposed_on_mcp`
...
- **ratified in:** hv, 2026-08-22, confirmed in session to ic; recorded in this row's `ratification` field, whose text carries the ruling and its route
- **MCP:** exposed as an agent tool -- **mutates**
- **recoverability:** idempotent
