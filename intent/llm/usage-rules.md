...
- **Elixir Patterns**: See the Elixir agent at `~/.claude/agents/elixir.md`
- **MeetZaya-Specific**: See `meetzaya-specific.md` in this directory
- **Package Usage Rules**: See `AGENTS.md` for auto-generated package usage rules
