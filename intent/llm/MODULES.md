...
| Shared helpers          | `bin/intent_helpers`    | error(), checksum, terminal width, default width (get_default_width, ST0051), get_intent_version (single fallback site), read_config_field/get_config_field, find_project_root, resolve_st_dir, resolve_wp_dir (THE WP-dir resolver -- issue 0004), normalise_st_id, parse_wp_specifier (ST0050), ext_root_dir/ext_enumerate_names, get/add/remove_project_language (ST0037, ST0042/WP-05), has_project_language (THE declared-language predicate -- issue 0008), stamp_project_version (THE intent_version stamper, shared by intent_upgrade + bin/release), canonical_status (single status synonym table, relocated from intent_st -- issue 0002)                                                                                                                         |
