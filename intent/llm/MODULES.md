...
| Shared helpers          | `bin/intent_helpers`    | error(), checksum, terminal width, get_intent_version (single fallback site), read_config_field/get_config_field, find_project_root, resolve_st_dir, normalise_st_id, ext_root_dir/ext_enumerate_names, get/add/remove_project_language (ST0037, ST0042/WP-05) |
