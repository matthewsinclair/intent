...
| Acceptance AC/AT mgmt   | `bin/intent_acceptance` | ac list/status/satisfy, at list/red/green/na (+ done/notdone aliases); close-gate precondition for st/wp done; reads/writes acceptance.md only (ST0044)                                                                                                                                                                                                                                                                                                                            |
