# archived from hv/inbox.ic.md -- 2026-09-03, by ic on hv's instruction

**BYTE-EXACT RECORD OF THE PRE-LEAN INBOX IS `ic/.history/20260903/hv-inbox-prefold-1717Z.md` (sha256 `3febc75db17f7186...`); this file is whitespace-normalised by the formatter.**

**THREE ENTRIES, EACH DISCHARGED BEFORE ARCHIVING, WITH THE DISCHARGE NAMED.** A removed entry and an entry never written are indistinguishable later, which is why the reasons are here and not only in a commit message.

- **(2026-08-21 14:27Z)** -- a work announcement for `AT-07.7`. The row landed; the announcement had no residue.
- **(2026-08-21 14:43Z)** -- uncommitted `surface/` edits plus the warning that a `reset` in this shared checkout ate one of them. The edit committed long ago. **The durable half is NOT lost: the shared-checkout hazard lives in ic's watch-outs**, which is its proper home.
- **(2026-08-29 13:49Z)** -- v3.0.0 shipping the `0133` defect. **DISCHARGED BY A RULING, not by time:** its one unresolved question was whether `AC-12.4` was stale or the release had outrun its gate. **`AC-12.4` was REWORDED 2026-09-01 by vc under hv's pen, executing hv's 08:32Z ruling** -- the row now reads _the release being cut_ and is unsatisfied only because v3.0.1 is not cut.
