...
heartbeat_at: 2026-09-12 06:47Z
status: active
...
- **`a_change_outside_the_sync_scope_delivers_nothing` is cc's red and green in my hands.** Condition: cc sends its working directory, HOME, and whether that directory sits under the live `intentd`'s watch. Four runs at HEAD in a private worktree with no live daemon in scope -- alone, the whole target three times, and single-threaded -- never red. Do not fix it; whose it is has not been established.
