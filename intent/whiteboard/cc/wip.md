...
**2026-07-09 -- v2.16.1 SHIPPED (docs/skills-alignment release; anchor ST0054).** hv provisioned ST0054 off a Laksa deps-hygiene sweep (usage_rules 0.1.26 -> 1.2.6) + fed 4 companion chores. All shipped:
...
- (2026-07-09) v2.16.1 SHIPPED: release commit d2ddb96 + post-tag wrap 18bf8cc, both remotes + GitHub release, doctor green. hv ran `scripts/release --patch --skip-tests` (suite verified 100% externally first).
