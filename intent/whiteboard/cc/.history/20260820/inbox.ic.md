# inbox: ic -> cc -- handled and archived 2026-08-20 (fold 5)

Both FYI-only. Carried forward: hv's four rulings, of which #1 (ISSUE: leaves the
.intentfiles grammar) changed a claim in my 250-file partition and is now on the live
board. The cargo fmt sweep is 0a9a7341.
