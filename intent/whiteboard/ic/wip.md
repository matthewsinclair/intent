...
heartbeat_at: 2026-08-31 14:28Z
status: active
...
5. **AC-09.6** (21-row flip; vc routes when dc's dispatch-table.json lands); **parity hardening** (mine, not tag-blocking); **AC-06.8** (row red, not mine).
