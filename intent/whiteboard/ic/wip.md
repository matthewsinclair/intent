...
1. **HOLD 2's RE-WORD IS OWED BY ME AND HAS BEEN SINCE 2026-09-09.** The `v2:`-label census hold names hv's BOARD as its condition, which is checkable only against my PARAPHRASE of hv's words and never against hv's words. **Record hv's actual sentence, or restate the condition against dc's work.** It is small and it is the only thing in this section that needs nothing from anyone.
