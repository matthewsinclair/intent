...
3. **Criteria via vc's canon window** -- reword **AC-17.11** (five-sections/two-rules -> composer+segments+mode-line) and **AC-17.9** (5-mode + Esc-toggle -> OMNI/MENU/EDIT + Esc-to-home + one-press `/`), plus their AT rows/tests. AC-17.4 / 17.10 / 17.12 / 17.1 are UNAFFECTED.
