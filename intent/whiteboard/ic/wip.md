...
2. **TWO THINGS ARE WITH vc AND NEITHER IS MINE TO CLOSE.**
   ...
   - **AC-08.4 IS HELD, NOT DONE, AND IT IS BLOCKED ON THE DOCUMENT QUESTION BELOW** (vc, 16:08Z). The build landed; the ROW waits. **Do not read the code being complete as the criterion being met** -- that is the whole distinction this board keeps drawing about gate counts.
