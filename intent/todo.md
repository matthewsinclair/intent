...
- [-] ST0078: Using Intent on a multi-person project with a Git workflow including PRs
  ...
  - [ ] 05: P5: one command after a pull -- bare intent sync prints the plan for this clone, --apply applies it, --to-disk and --to-store keep their meanings; quiet, reversible and non-reversible steps, --yes for the reversible asks, the hooks run the quiet subset
