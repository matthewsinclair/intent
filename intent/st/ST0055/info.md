...
| ----- | --------------------------------------------------------------------------------------------------------- | ---- | ------ |
| WP-01 | Foundation & format: dir-per-issue canon, Intent-owned template, scaffold, MODULES row, dispatch skeleton | S    | Done   |
| WP-02 | Create & list: add (dir-per-issue, id alloc, stamp), list --kind open/closed/all                          | S    | Done   |
| WP-03 | Inspect & lifecycle: show (+--json), close, open (move NNNN dir + status mirror)                          | S    | Done   |
| WP-04 | Gate & integration: bats green, critic-shell clean, intent help, doctor, ac gate                          | S    | Done   |
| WP-05 | Fleet normalisation (POST-SHIP, cross-repo): normalise Utilz/Lamplight intent/issues to canon             | S    | Done   |
