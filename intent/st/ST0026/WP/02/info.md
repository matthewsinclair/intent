...
Acceptance Criteria for this work package live in `ST0026/acceptance.md`, under the `WP-02` heading -- the single source of truth. This cover never restates them.
