...
Acceptance Criteria for this work package live in `ST0042/acceptance.md`, under the `WP-06` heading -- the single source of truth. This cover never restates them.
