...
Acceptance Criteria for this work package live in `ST0023/acceptance.md`, under the `WP-04` heading -- the single source of truth. This cover never restates them.
