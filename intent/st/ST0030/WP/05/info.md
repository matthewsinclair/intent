...
wp_id: WP-05
title: "in-debug Skill"
scope: Small
status: Done
---

# WP-05: in-debug Skill

## Objective

Create a new `in-debug` skill that provides a systematic 4-phase debugging procedure with a 3-strike architectural review guardrail. Adapted from Superpowers' `systematic-debugging` skill.

## Deliverables

### `intent/plugins/claude/skills/in-debug/SKILL.md`
...
- [ ] `intent/plugins/claude/skills/in-debug/SKILL.md` exists with proper frontmatter
- [ ] Includes all 4 phases and the 3-strike rule
- [ ] Includes Red Flags table
- [ ] Includes `chains_to:` field
- [ ] Registered in MODULES.md
- [ ] `intent claude skills install in-debug` succeeds
- [ ] `intent claude skills list` shows `in-debug`
