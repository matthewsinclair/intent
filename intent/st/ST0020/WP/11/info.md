...
Acceptance Criteria for this work package live in `ST0020/acceptance.md`, under the `WP-11` heading -- the single source of truth. This cover never restates them.
