...
Acceptance Criteria for this work package live in `ST0034/acceptance.md`, under the `WP-09` heading -- the single source of truth. This cover never restates them.
