...
Status as of: 2026-04-23 (WP09 closed; WP01 + WP02 + WP03 + WP04 + WP05 + WP06 + WP07 + WP08 + WP09 + WP12 done — 10/12; v2.8.2 → v2.9.0 migration step authored and chain-wired across all prior cases; canary dry-run gated on user, deferred until pre-WP11)
