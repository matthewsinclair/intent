...
agent_commands.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`subagents\`, which v3 DECLARES and has not implemented -- \"a known command that is not implemented yet\" is a PENDING IMPLEMENTATION, not a departure. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
claude_prime.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`prime\`, which v3 DECLARES and has not implemented -- \"a known command that is not implemented yet\" is a PENDING IMPLEMENTATION, not a departure. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
ext_discovery.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`rules\` + \`skills\` (WIRED in v3) and \`subagents\` (declared, not yet implemented) -- a mixed file, and mixedness is about which verbs it touches, not about its class. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
rule_index.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`rules\`, WIRED in v3 and answering at rc=0. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
rule_validator.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`rules\`, WIRED in v3 and answering at rc=0. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
skills_commands.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`skills\`, WIRED in v3 and answering at rc=0. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
test_diogenes.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`skills\` (WIRED in v3) and \`subagents\` (declared, not yet implemented) -- a mixed file, and mixedness is about which verbs it touches, not about its class. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
ambient_project_root_guard.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`subagents\`, which v3 DECLARES and has not implemented -- \"a known command that is not implemented yet\" is a PENDING IMPLEMENTATION, not a departure. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
au_language_code_guard.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`rules\`, WIRED in v3 and answering at rc=0. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
co_language_code_guard.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`rules\`, WIRED in v3 and answering at rc=0. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
intent_upgrade_dispatcher.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`upgrade\`, WIRED in v3 and answering at rc=0. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
intent_upgrade_orchestrator.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`upgrade\`, WIRED in v3 and answering at rc=0. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
no_absolute_home_paths.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`upgrade\`, WIRED in v3 and answering at rc=0. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row. MIXED IN CAUSE: only its t4 is this deviation; its t5 is issue 0202 and is unrelated.
pr_language_code_guard.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`rules\`, WIRED in v3 and answering at rc=0. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
rule_pack_agnostic.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`rules\`, WIRED in v3 and answering at rc=0. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
rule_pack_author.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`rules\`, WIRED in v3 and answering at rc=0. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
rule_pack_content.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`rules\`, WIRED in v3 and answering at rc=0. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
rule_pack_elixir.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`rules\`, WIRED in v3 and answering at rc=0. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
rule_pack_lua.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`rules\`, WIRED in v3 and answering at rc=0. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
rule_pack_prose.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`rules\`, WIRED in v3 and answering at rc=0. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
rule_pack_rust.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`rules\`, WIRED in v3 and answering at rc=0. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
rule_pack_shell.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`rules\`, WIRED in v3 and answering at rc=0. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
rule_pack_swift.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`rules\`, WIRED in v3 and answering at rc=0. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
test_autopsy.bats|deviate|vc ruling 2026-08-31|Aimed at a DEAD ENTRY POINT for a verb v3 KEEPS. 125f601d (AC-12.1 cutover prune) deleted the v2 PLUGIN SCRIPTS under intent/plugins/claude/bin/, NOT the commands -- v3 carries its own Rust implementations. This file reaches \`skills\`, WIRED in v3 and answering at rc=0. Every verb involved is disposition \`keep\` in surface/dispatch-table.json, whose vocabulary this register shares VERBATIM, so \`retire\` here would put two artefacts in contradiction in the one place they are ruled to agree, and would delete live coverage for shipping surface -- the hazard this table header names. Classified by ruling; the burn measurement is what it always was and is no longer what decides the row.
"
...
RATIFICATIONS="
agent_commands.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
claude_prime.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
ext_discovery.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
rule_index.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
rule_validator.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
skills_commands.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
test_diogenes.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
ambient_project_root_guard.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
au_language_code_guard.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
co_language_code_guard.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
intent_upgrade_dispatcher.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
intent_upgrade_orchestrator.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
no_absolute_home_paths.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
pr_language_code_guard.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
rule_pack_agnostic.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
rule_pack_author.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
rule_pack_content.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
rule_pack_elixir.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
rule_pack_lua.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
rule_pack_prose.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
rule_pack_rust.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
rule_pack_shell.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
rule_pack_swift.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
test_autopsy.bats|UNRATIFIED -- no D-number in design.md covers the AC-12.1 plugin-script prune. D10 (shell pruned at the cut) is the CANDIDATE and is deliberately NOT used: supplying a plausible reference is the laundering this column exists to prevent. vc/hv to ratify or mint.
"
