...
no_absolute_home_paths.bats|deviate|vc ruling 2026-08-31 on D10|Aimed at the dead v2 plugin-script entry point; the verb itself is kept. This file reaches \`upgrade\` (WIRED in v3, answers at rc=0). MIXED IN CAUSE: only t4 is this deviation; t5 is issue 0202, unrelated.
...
rule_index.bats|D10
rule_validator.bats|D10
skills_commands.bats|D10
test_diogenes.bats|D10
ambient_project_root_guard.bats|D10
au_language_code_guard.bats|D10
co_language_code_guard.bats|D10
intent_upgrade_dispatcher.bats|D10
intent_upgrade_orchestrator.bats|D10
no_absolute_home_paths.bats|D10
pr_language_code_guard.bats|D10
rule_pack_agnostic.bats|D10
rule_pack_author.bats|D10
rule_pack_content.bats|D10
rule_pack_elixir.bats|D10
rule_pack_lua.bats|D10
rule_pack_prose.bats|D10
rule_pack_rust.bats|D10
