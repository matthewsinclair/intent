...
- AT-03.7 `crates/intentsvcs/tests/ignored_paths_corpus.rs` -- covers AC-03.7 -- status: to-write -- must include the machine-scope arm: a file matched only by `core.excludesFile` stays IN the corpus
