...
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---- | ------ |
| WP-01 | P1: the event log travels -- one committed file per event under intent/.canon/events/YYYY/MM/DD, additive ingest, principal is the author (reverses D53)                                                                                                     | M    | Done   |
| WP-02 | P2: renumber verbs -- intent st renumber and intent issues renumber repair an id two clones both minted                                                                                                                                                      | M    | Done   |
...
| WP-04 | P4: working in a team -- the docs/concepts page written from driven commands, the-store.md corrections, a CI doctor job on the merge result                                                                                                                  | S    | Done   |
