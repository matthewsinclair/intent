...
| WP-17 | The structured query door: intent search --sql, read-only over the published schema                                     | S    | Not Started |
| WP-18 | The corpus: the gitignore-aware repository, two staleness policies, the widened watcher                                 | L    | Not Started |
