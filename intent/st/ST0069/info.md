...
status: WIP
status_reason: 0366: WP-22's daemon-served search answers from an index the daemon never builds when it opens a project; the fix and its AC/AT land here (vc under the pen, 2026-09-13)
created: 2026-08-30
completed:
---
...
| WP-14 | Coordination model: whiteboard and inboxes in the store, with a bounded API                                             | L    | Done      |
