...
Status as of: 2026-04-23 (WP10 closed; 11/12 done — only WP11 (release + fleet upgrade) remains. WP10 absorbed a mid-WP scope expansion: full TCA suite refactor for the rule library + total-codebase-audit.md update + `rules:` frontmatter pass on Elixir skills. CHANGELOG and release-notes drafts staged for WP11.)
...
| WP09 | Migration and upgrade chain        | Done        | migrate_v2_8_2_to_v2_9_0 + needs_v2_9_0_upgrade + generate_ext_readme in bin/intent_helpers; chain wired in bin/intent_upgrade (gate + 16 chain-tails + new "2.8.2" case); ext_migration.bats with 28 tests; canary dry-run deferred (user-gated).                                                                                                                                                                                                |
| WP10 | Documentation                      | Done        | New docs (rules.md, writing-extensions.md expanded, critics.md updated); CLAUDE.md / MODULES.md / DECISION_TREE.md / creating-custom-agents.md / help files updated; AGENTS.md regenerated; CHANGELOG + release-notes drafts; tests/unit/docs_completeness.bats (11 tests); +TCA suite refactor for rule library; +total-codebase-audit.md updated for v2.9.0; +rules: frontmatter on Elixir skills. 707/707 BATS green; 48/48 rules validate ok. |
