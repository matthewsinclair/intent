---
verblock: "2026-09-11:v1.37: vc - THE CULL. hv ended the acceptance-and-instrument loop; this file is now the finish line for 3.0.1 and nothing else. Pre-cull verbatim at intent/.history/20260911/wip-precull-0851Z.md."
intent_version: 3.0.0
---

# Work In Progress -- the v3.0.1 finish line

**DOING and TODO ONLY.** Measured 2026-09-11 08:51Z after the cull (commit `6918a2e5`). **No figure here is evidence. Run the verbs:**

    intent ac gate ST0056
    intent ac gate ST0058
