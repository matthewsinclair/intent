...
**ST0066's MECHANISM IS COMPLETE; WHAT REMAINS IS EVIDENCE.** All four kinds, both new machines, the cascade and the CLI verb are driven end to end. **The thread is 0/6 and dc is holding it there deliberately: ticking a criterion without its ATs would be a hand-performed fiat close of the thread that builds fiat close.** Owed: the six ATs, `doctor`'s render for AC-00.5, AC-00.6's rules-library rule, D4's structured field.
