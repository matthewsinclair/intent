...
| `status`              | enum         | `active` (default), `draft`, `deprecated`. The headless critic arms only `active` rules, and the critic subagents apply only those. Defaults to `active` if omitted.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
