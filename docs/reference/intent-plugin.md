...
**Exit codes** follow the surface-wide contract on the [index](index.md#exit-codes) (INV-04). `intent plugin --help`, and your own binary, are the authority on this verb.
...
**Exit codes** follow the surface-wide contract on the [index](index.md#exit-codes) (INV-04). `intent plugin list --help`, and your own binary, are the authority on this verb.
...
**Exit codes** follow the surface-wide contract on the [index](index.md#exit-codes) (INV-04). `intent plugin show --help`, and your own binary, are the authority on this verb.
