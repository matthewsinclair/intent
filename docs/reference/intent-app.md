...
| -------------------- | --------------------------------------------------------------------------- | -------------------------------- | --------------- | ---------- |
| `intent app`         | Manage the Intent menubar app on this machine                               | **no -- newer than the release** | read            | --         |
| `intent app start`   | Start the Intent menubar app                                                | **no -- newer than the release** | mutate          | reversible |
| `intent app stop`    | Stop the Intent menubar app                                                 | **no -- newer than the release** | mutate          | reversible |
| `intent app restart` | Restart the Intent menubar app                                              | **no -- newer than the release** | mutate          | reversible |
| `intent app status`  | Report whether the Intent menubar app is running, and where it is installed | **no -- newer than the release** | read            | --         |
