...
**Exit codes** follow the surface-wide contract on the [index](index.md#exit-codes) (INV-04). `intent modules --help`, and your own binary, are the authority on this verb.
...
**Exit codes** follow the surface-wide contract on the [index](index.md#exit-codes) (INV-04). `intent modules check --help`, and your own binary, are the authority on this verb.
...
**Exit codes** follow the surface-wide contract on the [index](index.md#exit-codes) (INV-04). `intent modules find --help`, and your own binary, are the authority on this verb.
