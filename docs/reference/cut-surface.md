...
**Generated by `intent/st/ST0056/parity/tools/gen_cut_surface.sh` at 2026-09-18 07:59Z. Do not edit -- re-run it.**

|                         |                                                       |
| ----------------------- | ----------------------------------------------------- |
| Revision this describes | `493705d980f4a61aef6c8e169ee699559411d03f` (`HEAD`)   |
| Compared against        | `46599d14547d676ca568682063c5b60961eb9e6d` (`v3.0.3`) |
...
Commands at `HEAD` that `v3.0.3` does NOT have -- **anything documented from these describes a tool nobody has installed**:
...
Flags at `HEAD` that `v3.0.3` does NOT have:
