...
**Generated by `intent/st/ST0056/parity/tools/gen_cut_surface.sh` at 2026-09-25 12:48Z. Do not edit -- re-run it.**

|                         |                                                       |
| ----------------------- | ----------------------------------------------------- |
| Revision this describes | `b4099f9e6b7f473fdc187f271fe17ea21d7c64f6` (`HEAD`)   |
| Compared against        | `227e682358b1b3bde4d77a276f3731b3ed61ae08` (`v3.2.1`) |
...
No command exists at `HEAD` that is absent from `v3.2.1`.
...
No flag exists at `HEAD` that is absent from `v3.2.1`.

Flags `v3.2.1` has that `HEAD` does not, **partitioned by whether the command survived**:

On a command that STILL SHIPS -- **an independent flag regression, and the only kind that is news here**:

- `index rebuild` loses `--corpus`
