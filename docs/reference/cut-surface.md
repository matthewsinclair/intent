...
**Generated by `intent/st/ST0056/parity/tools/gen_cut_surface.sh` at 2026-09-21 09:43Z. Do not edit -- re-run it.**

|                         |                                                       |
| ----------------------- | ----------------------------------------------------- |
| Revision this describes | `c4eca5d7eee99cd9064e0c829cc713da9d7f8a9b` (`HEAD`)   |
| Compared against        | `11ce80ad58e3a3e3582c98dfcab5dedc26812e17` (`v3.1.0`) |
...
Commands at `HEAD` that `v3.1.0` does NOT have -- **anything documented from these describes a tool nobody has installed**:
...
Flags at `HEAD` that `v3.1.0` does NOT have:

- `st relate` gains `--note`
