...
**Generated by `intent/st/ST0056/parity/tools/gen_cut_surface.sh` at 2026-08-30 09:29Z. Do not edit -- re-run it.**
...
| Commands shipped at this revision  | **125**                                               |
| Commands shipped at the baseline   | 117                                                   |
| Refusals declared at this revision | 50                                                    |
...
The 50 refusal variants declared at this revision, from `ALL_VARIANTS` in `native/rust/crates/intentsvcs/tests/error_remedies.rs`.
