...
The commands Intent ships at `1c55a3485`, by page. Your own binary lists its surface: `intent --help` and `intent <family> --help`.
...
Measured by comparing the register at `1c55a3485` with the register at `v3.0.1`.

The surface at `1c55a3485` is identical to `v3.0.1`.
