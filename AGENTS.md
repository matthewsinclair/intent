...
- **in-whiteboard** -- Multi-session coordination via intent/whiteboard/: claim ST scopes, signal cross-stream, heartbeat, release on session end
...
_Generated by Intent v2.11.11 on 2026-06-11_
