...
This project uses Intent. Run `intent doctor` for the installed version; see `intent claude skills list` and `intent claude subagents list` for the full Intent-provided surface.
