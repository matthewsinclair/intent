...
This project uses Intent v[[INTENT_VERSION]]. See `~/.intent/ext/`, `intent claude skills list`, and `intent claude subagents list` for the full Intent-provided surface.
