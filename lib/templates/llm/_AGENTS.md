...
[[PROJECT_NAME]] -- an Intent project. See `CLAUDE.md` for the Claude-specific overlay.
...
- Swift toolchain (see `Package.swift` for the tools version)
  [[/lang]]
  [[#lang lua]]
- Lua (see the project's own docs for the target version)
  [[/lang]]
  [[#lang shell]]
...
- Bats testing framework
  [[/lang]]
  [[#nolang]]
- None declared. Declare the project's languages with `intent lang init <lang>`.
  [[/nolang]]
...
- Follow Swift conventions enforced by `swift format`.
  [[/lang]]
  [[#lang lua]]
- Follow the project's Lua conventions; 2-space indentation.
  [[/lang]]
  [[#lang shell]]
...
_Generated by Intent v[[INTENT_VERSION]] from `lib/templates/llm/_AGENTS.md`._
