...
pub const EDGES: &[Edge] = &[
  ...
  Edge::new(Mode::Menu, "Typing", Mode::Menu, "filter the palette"),
  Edge::new(Mode::Menu, "Move", Mode::Menu, "pick among the hits"),
  Edge::new(Mode::Menu, "Enter", Mode::Omni, "run the picked command"),
