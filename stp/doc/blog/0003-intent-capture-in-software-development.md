...
STP attacks intent loss through systematic capture and preservation. Rather than hoping developers document intent, STP makes it part of the natural workflow.

### Documentation Alongside Code

STP keeps documentation in the repository, versioned with the code:
```
project/
├── src/           # Implementation
└── stp/
...
STP templates ask the right questions at the right time:
...
STP maintains intent at multiple levels:
...
#### After: With STP-Style Intent Capture
...
Teams using STP-style intent capture report:
...
[Continue to: LLM Collaboration with STP →](./0004-llm-collaboration-with-stp.md)
